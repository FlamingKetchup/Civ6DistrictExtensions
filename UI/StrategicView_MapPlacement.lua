-- ===========================================================================
-- Script changes it so only tiles adjacent to the specialty district
-- or a previous extension are highlited, when placing extensions
-- ===========================================================================
include("SupportFunctions.lua");
include("AdjacencyBonusSupport.lua");
include("PopupDialog");
include("Civ6Common.lua");
-- Needed for mod helper function
include( "MapEnums" );

print("Running DistrictExtensions' replacemennt of StrategicView_MapPlacement")
-- ===========================================================================
--	MEMBERS
-- ===========================================================================
...
function RealizePlotArtForDistrictPlacement()
	...
	if pSelectedCity ~= nil then
        ...
        -- Mod changes, test if tile is valid
        if validExtensionPlot(kPlot, district.Index) then
  				local plotInfo	:table			= GetViewPlotInfo( kPlot, m_hexesDistrictPlacement );
  				plotInfo.hexArtdef				= "Placement_Valid";
  				plotInfo.selectable				= true;
  				m_hexesDistrictPlacement[plotId]= plotInfo;
