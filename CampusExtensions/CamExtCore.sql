...
VALUES ('DISTRICT_LIBRARY', 'KIND_DISTRICT'),
       ...
       ('FEATURE_LIBRARY_DUMMY', 'KIND_FEATURE'),
       ('FEATURE_UNIVERSITY_DUMMY', 'KIND_FEATURE'),
       ('FEATURE_RESEARCH_LAB_DUMMY', 'KIND_FEATURE')*/;
...
VALUES ('FEATURE_LIBRARY_DUMMY', 'LOC_FEATURE_LIBRARY_DUMMY_NAME'),
       ('FEATURE_UNIVERSITY_DUMMY', 'LOC_FEATURE_UNIVERSITY_DUMMY_NAME'),
       ('FEATURE_RESEARCH_LAB_DUMMY', 'LOC_FEATURE_RESEARCH_LAB_DUMMY_NAME');

INSERT INTO District_RequiredFeatures (DistrictType, FeatureType)
VALUES ('DISTRICT_LIBRARY', 'FEATURE_LIBRARY_DUMMY'),
       ('DISTRICT_UNIVERSITY', 'FEATURE_UNIVERSITY_DUMMY'),
       ('DISTRICT_MADRASA', 'FEATURE_UNIVERSITY_DUMMY'),
       ('DISTRICT_RESEARCH_LAB', 'FEATURE_RESEARCH_LAB_DUMMY');
*/
